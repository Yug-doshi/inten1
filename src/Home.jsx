          ...
          <div className="row">
            <div className="col-sm-12">
              ...
              <p className="gallery_text">
                ...
                lorem Ipsum the industry'ndard dummy text ever since of the
                1500s, when an unknown printer took a galley of type and scra
          ...
          <div className="row">
            <div className="col-sm-12">
              ...
              <p className="client_text">
                Eeven slightly believable. If you are going to use a passage of
                      ...
                      <div className="testimonial_section_2">
                        <h4 className="client_name_text">
                          ...
                          <span className="quick_icon">
                            <img src="images/quick-icon.png" alt="Quick Icon" />
                          </span>
                        </h4>
                        <p className="customer_text">
                          ...
                          of text. All themany variations of passages of Lorem
                          Ipsum available, but the majority have suffered
                          alteration in some embarrassing hidden in the middle
                          of text. All the
                        </p>
                      </div>
                    </div>
